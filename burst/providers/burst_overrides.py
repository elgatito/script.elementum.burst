...
overrides = {
    ...
    # Rutor
    'rutor': {
        'anime_query': "0/10/100/2/QUERYEXTRA",
        'movie_query': "0/1/100/2/QUERYEXTRA",
        'season_query': "0/4/100/2/QUERYEXTRA",
        'show_query': "0/4/100/2/QUERYEXTRA",
        'season_keywords': "{title} [{season:2}x01",
        'season_keywords2': "{title} [S{season:2}]",
        'tv_keywords': '{title} s{season:2}e{episode:2}',
